...
class CookieTest extends TestCase
{
    public function testToString()
    {
        ...
        $this->assertEquals('foo=; expires=Thu, 01 Jan 1970 00:00:01 GMT; domain=.myfoodomain.com; path=/Webservice/; httponly', (string) $cookie, '->__toString() returns string representation of a cleared cookie if value is NULL');
